...
# Simple approximation of area under the curve - constant line y=midPoint is  (n=0)
...
#to change ->
    ...
    secondDerivative = ((12*zeta)-(math.cos(zeta)))
...
def simpleSimpson(a, b, h):
    ...
    #to change ->
    zeta=0.5
    fourthDerivative = math.cos(zeta)
